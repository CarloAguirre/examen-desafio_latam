...
export const Aside = ({page}) => {
  ...
  return (
    ...
    <div className={page === 'productos' ? 'categorias-productos' : 'categorias'}>
      <p onClick={()=>setCategoria('all')}><span className="material-icons-outlined">
        shuffle
      </span>TODAS</p>
      <p onClick={()=>setCategoria('NINTENDO')}><img src="https://res.cloudinary.com/dezwpnks0/image/upload/c_scale,w_50/v1693330540/Nintendo_red_logo.svg_ygqlsr.webp" alt="nintendo_logo"/>  NINTENDO</p>
